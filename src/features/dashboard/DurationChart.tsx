...
const ChartBox = styled.div`
  ...
  & > *:first-child { margin-bottom: 1.6rem; }
  & .recharts-pie-label-text { font-weight: 600; }
`;

interface DurationData { duration: string; value: number; color: string; }
...
function prepareData(startData: DurationData[], stays: any[]) {
...
interface DurationChartProps { confirmedStays: any[]; }
