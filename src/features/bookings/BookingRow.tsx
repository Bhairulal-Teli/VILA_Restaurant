...
`;
const Amount = styled.div`font-family: "Sono"; font-weight: 500;`;
...
function BookingRow({ booking: { id: bookingId, startDate, endDate, numNights, totalPrice, status, guests: { fullName: guestName, email }, cabins: { name: cabinName } } }: BookingRowProps) {
