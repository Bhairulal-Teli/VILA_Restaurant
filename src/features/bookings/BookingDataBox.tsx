...
const Header = styled.header`
  ...
  svg { height: 3.2rem; width: 3.2rem; }
  & div:first-child { display: flex; align-items: center; gap: 1.6rem; font-weight: 600; font-size: 1.8rem; }
  & span { font-family: "Sono"; font-size: 2rem; margin-left: 4px; }
`;

const Section = styled.section`padding: 3.2rem 4rem 1.2rem;`;
...
const Guest = styled.div`
  ...
  & p:first-of-type { font-weight: 500; color: var(--color-grey-700); }
`;
...
const Price = styled.div<{ isPaid: boolean }>`
  ...
  & p:last-child { text-transform: uppercase; font-size: 1.4rem; font-weight: 600; }
  svg { height: 2.4rem; width: 2.4rem; color: currentColor !important; }
`;
